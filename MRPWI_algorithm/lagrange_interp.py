...
across the parameter domain. The method assumes that the modes have already
been ranked, conjugate‑paired, and phase‑aligned, ensuring one‑to‑one modal
correspondence across all training parameters.
