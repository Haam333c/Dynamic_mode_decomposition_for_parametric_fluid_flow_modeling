"""
Utility functions for post‑processing OpenFOAM simulations.

Includes:
- force coefficient loading
- FFT computation
- uniform time interpolation
- weighted SVD computation for flow fields

Adapted from:
https://github.com/JanisGeise/buffet_oat15/blob/jgeise/post_processing/utils.py
"""
