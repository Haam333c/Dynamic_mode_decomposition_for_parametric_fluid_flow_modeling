"""
Utilities for loading masked OpenFOAM fields for transonic buffet analysis.

Includes:
- masked spatial field extraction (scalar, vector, tensor)
- construction of training and test snapshot matrices
- temporal sampling and masking
- lift coefficient loading and optional interpolation
- storage of cell areas for weighted modal analysis
"""
...
def load_buffet_training_snapshots(
    ...
    # Initialize per-alpha Cl dictionaries
    data.cl_raw_dict = {}
    data.cl_uniform_dict = {}
    ...
    for alpha in param_list:
        ...
        if "cl" in fields:
            ...
            # Cl sampled at CFD snapshot times
            ...
            # Store Cl per alpha
            data.cl_raw_dict[alpha] = (t_cl_raw, cl_raw)
            data.cl_uniform_dict[alpha] = (t_cl_uni, cl_uni)
